...
Der Aktienmarkt im Spiel verfolgt den realen Aktienmarkt und kombiniert mehrere nicht offengelegte reale Kurse, um einen dynamischen und unvorhersehbaren Markt zu schaffen. Dies geschieht, damit niemand den Markt manipulieren kann, indem er große Mengen an Aktien kauft oder verkauft – ähnlich wie beim realen Aktienmarkt; deine Kauf- oder Verkaufsaufträge können den Aktienkurs nicht beeinflussen (es sei denn, du bist Milliardär).

## Wie werden die Verkaufs- und Einkaufspreise ermittelt?

Der Preis wird in Echtzeit anhand der Kurse des realen Aktienmarktes berechnet. Aufgrund von Netzwerkverzögerungen, Spreads und anderen Faktoren kann der auf deinem Bildschirm angezeigte Preis geringfügig vom tatsächlichen Marktpreis abweichen, zu dem du kaufst oder verkaufst.
...
## Beeinflussen meine Trades die Aktienkurse?

**Nein, deine einzelnen Kauf- und Verkaufsaufträge haben keinen Einfluss auf die Aktienkurse.**

Dies ist **absichtlich so konzipiert**, aus mehreren wichtigen Gründen:

**Fairness & Manipulationsschutz**:

- Wir wollen eine faire Handelsumgebung für alle Spieler gewährleisten.
- Kein einzelner Spieler oder keine Gruppe kann die Aktienkurse zu ihrem Vorteil manipulieren.
- Verhindert "Pump and Dump"-Schemata oder koordinierte Marktmanipulationen.
- Jeder handelt zu den gleichen marktgerechten Preisen, unabhängig von seinem Vermögen.

**Verfolgung des realen Marktes**:

- Die Aktienkurse basieren auf realen Marktdaten und mehreren nicht offengelegten Kursen.
- Dies schafft eine echte Unvorhersehbarkeit, die nicht ausgetrickst oder vorhergesagt werden kann.
- Marktverschiebungen spiegeln tatsächliche wirtschaftliche Ereignisse und Trends wider, nicht das Handeln von Spielern.
- Stellt sicher, dass der Erfolg auf Marktanalysefähigkeiten basiert, nicht auf Marktmanipulation.

**Gleiches Spielfeld**:

- Neue Spieler werden nicht durch wohlhabende Spieler benachteiligt, die die Preise kontrollieren.
- Der Handelserfolg basiert auf Timing und Marktkenntnis, nicht auf finanzieller Dominanz.
- Erhält das Gleichgewicht zwischen allen Spielern.

Dieses System spiegelt wider, wie reale Aktienmärkte für einzelne Privatanleger funktionieren – es sei denn, du handelst mit Milliarden, bewegen deine einzelnen Aufträge den Marktpreis nicht.

## Was ist Unrealisierter Gewinn/Verlust im Vergleich zu Realisiertem Gewinn/Verlust?

- **Unrealisierter Gewinn/Verlust**: Dein aktueller Gewinn/Verlust bei Aktien, die du noch besitzt. Dies ändert sich mit den Schwankungen der Aktienkurse und zeigt potenzielle Gewinne/Verluste an.
- **Realisierter Gewinn/Verlust**: Dein tatsächlicher Gewinn/Verlust aus abgeschlossenen Trades. Dieser wird aktualisiert, wenn du Aktien verkaufst und deine dauerhafte Handelsleistung darstellt.
...
- Dein aktueller Bestand (Anzahl der gehaltenen Aktien).
...
- **Halte Bargeldreserven**: Behalte etwas Eurodollars für neue Möglichkeiten bereit.
...
- **Sofortige Liquidation**: Gestohlene/beschlagnahmte Aktien werden sofort zu den aktuellen Marktpreisen verkauft.
