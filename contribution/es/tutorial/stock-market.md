...
El Mercado de Valores es donde puedes invertir tus Eurodólares en varias corporaciones para potencialmente aumentar tu riqueza mediante operaciones estratégicas. Puedes comprar y vender acciones de tres compañías principales utilizando datos del mercado en tiempo real.

## ¿Dónde puedo encontrar el Mercado de Valores?

Puedes acceder a él desde el menú cibernético.

## ¿Cómo compro acciones?

1. Toca cualquier compañía de la Lista de la Bolsa.
2. En la Página de Detalles de la Acción, toca el botón **OPERAR**.
3. Selecciona la pestaña **COMPRAR** en el modal de operaciones.
4. Introduce el número de acciones que deseas comprar utilizando el campo de entrada o el deslizador.
5. Revisa los detalles de la transacción, incluidas las tarifas de operación (0.4% + 20 Eurodólares de tarifa fija).
6. Toca **CONFIRMAR COMPRA** para completar la compra.

## ¿Cómo vendo acciones?

1. Abre el modal de operaciones para una acción que poseas.
2. Selecciona la pestaña **VENDER**.
3. Introduce el número de acciones a vender (solo puedes vender las que posees).
4. Revisa los detalles de la transacción, incluidas las tarifas de operación (0.4% + 20 Eurodólares de tarifa fija).
5. Toca **CONFIRMAR VENTA** para completar la venta.

## ¿Cuáles son las tarifas de operación?
...
- Todas las tarifas se calculan automáticamente y se muestran antes de que confirmes cualquier operación.

**Ejemplo**: Operar con acciones por valor de 10,000 ED incurre en 40 ED (0.4%) + 20 ED (fija) = 60 ED de tarifas totales.
...
## ¿Mis operaciones afectan los precios de las acciones?

**No, tus órdenes individuales de compra y venta NO afectarán los precios de las acciones de ninguna manera.**

Esto es **intencional por diseño** por varias razones importantes:

**Justicia y Anti-Manipulación:**

- Queremos garantizar un entorno comercial justo para todos los jugadores.
- Ningún jugador o grupo puede manipular los precios de las acciones en su beneficio.
- Evita esquemas de "inflar y vender" o manipulaciones coordinadas del mercado.
- Todos operan a los mismos precios impulsados por el mercado, independientemente de su nivel de riqueza.

**Seguimiento del Mercado Real:**

- Los precios de las acciones se derivan de datos reales del mercado y múltiples valores no revelados.
- Esto crea una imprevisibilidad genuina que no se puede manipular ni predecir.
- Los movimientos del mercado reflejan eventos y tendencias económicas reales, no las acciones de los jugadores.
- Garantiza que el éxito dependa de las habilidades de análisis del mercado, no de la manipulación del mercado.

**Igualdad de Condiciones:**

- Los nuevos jugadores no se ven perjudicados por los jugadores ricos que controlan los precios.
- El éxito comercial se basa en el tiempo y el conocimiento del mercado, no en el dominio financiero.
- Mantiene el equilibrio competitivo entre todos los niveles de riqueza de los jugadores.

Este sistema refleja cómo funcionan los mercados bursátiles reales para los inversores minoristas individuales: a menos que estés operando con miles de millones, tus órdenes individuales no mueven el precio del mercado.

## ¿Qué es el Beneficio/Pérdida No Realizado vs. el Beneficio/Pérdida Realizado?

- **Beneficio/Pérdida No Realizado**: Tu beneficio o pérdida actual en las acciones que aún posees. Esto cambia a medida que los precios de las acciones fluctúan y muestra ganancias o pérdidas potenciales.
- **Beneficio/Pérdida Realizado**: Tu beneficio o pérdida real de las operaciones completadas. Se actualiza cuando vendes acciones y representa tu rendimiento comercial permanente.
...
- El mercado rastrea el mercado real, por lo que **ES** de esperar que sea volátil de vez en cuando; puede dispararse a la luna o estrellarse contra el suelo debido a eventos mundiales, noticias, etc.
- Yo (Dexter) no tengo control sobre el mercado real, por lo que tampoco puedo controlar el precio de las acciones del juego.
...
- **Monitorea las tendencias**: Utiliza los gráficos de precios para analizar el rendimiento histórico.
...
## ¿Qué sucede con mis acciones si me asaltan o arrestan?
...
- **Sistema basado en la probabilidad**: El robo de acciones no está garantizado, depende de si el atacante logra piratear tu cartera.
