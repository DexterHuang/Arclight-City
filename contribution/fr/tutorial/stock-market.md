...
- Tous les frais sont calculés automatiquement et affichés avant que vous ne confirmiez une transaction

**Exemple**: Le trading d'actions valant 10 000 ED entraîne 40 ED (0,4 %) + 20 ED (frais fixes) = 60 ED de frais totaux
...
Cela est fait afin que les gens ne puissent pas manipuler le marché en achetant ou en vendant de grandes quantités d'actions, comme c'est le cas sur le marché boursier réel ; vos ordres d'achat ou de vente ne pourront pas modifier le prix de l'action (à moins que vous ne soyez un multimilliardaire)
...
Le graphique boursier est mis à jour toutes les **5 minutes** pendant les heures de négociation normales.
Cependant, les achats et les ventes se font aux prix du marché en temps réel.

## Mes transactions affectent-elles les prix des actions ?

**Non, vos ordres d'achat et de vente individuels n'affecteront en aucun cas les prix des actions.**

Cela est **intentionnel par conception** pour plusieurs raisons importantes:

**Équité et anti-manipulation**:

- Nous voulons garantir un environnement commercial équitable pour tous les joueurs
- Aucun joueur ou groupe unique ne peut manipuler les prix des actions à son avantage
- Empêche les schémas de "pompage et dégonflage" ou la manipulation coordonnée du marché
- Tout le monde échange aux mêmes prix dictés par le marché, quel que soit son niveau de richesse

**Suivi du marché réel**:

- Les prix des actions sont dérivés de données du marché boursier réel et de plusieurs valeurs mobilières non divulguées
- Cela crée une imprévisibilité réelle qui ne peut pas être truquée ou prédite
- Les mouvements du marché reflètent les événements et les tendances économiques réels, et non les actions des joueurs
- Garantit que le succès dépend des compétences d'analyse du marché, et non de la manipulation du marché

**Terrain de jeu égal**:

- Les nouveaux joueurs ne sont pas désavantagés par les joueurs riches qui contrôlent les prix
- Le succès commercial repose sur le timing et la connaissance du marché, et non sur la domination financière
- Maintient l'équilibre concurrentiel entre tous les niveaux de richesse des joueurs

Ce système reflète le fonctionnement des marchés boursiers réels pour les investisseurs particuliers : à moins que vous ne négociiez des milliards, vos ordres individuels n'affectent pas le prix du marché.
...
- **P&L réalisé**: Votre profit/perte réel provenant des transactions terminées. Ceci est mis à jour lorsque vous vendez des actions et représente votre performance commerciale permanente.
...
- Prix d'achat moyen de vos actions
- Montant et pourcentage actuels du profit/perte
- Valeur totale du marché de votre position

## Que dois-je savoir sur les risques du marché ?

- Le marché suit le marché réel, il est donc **NORMAL** qu'il soit parfois volatil ;
  Il peut s'envoler ou s'effondrer en raison d'événements, de nouvelles, etc. réels.
- Je (Dexter) n'ai pas le contrôle sur le marché réel et ne peux donc pas contrôler le prix des actions du jeu non plus.
...
- **P&L réalisé**: Profit/perte total de toutes les transactions terminées
...
- **100 % de chances**: L'ACPD saisira toujours un pourcentage de vos avoirs en actions lorsque vous serez arrêté
...
- **Probabilité plus faible**: Les tentatives d'agression ont une probabilité plus faible de vol réussi d'actions que les arrestations
...
- **L'attaquant reçoit le produit**: L'attaquant reçoit la valeur en espèces de vos actions liquidées, moins la taxe PvP standard
